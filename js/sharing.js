window.addEventListener("load",function(){
	...
	// Create full html
	var sharing = document.createElement("span");
	...
	sharing.innerHTML = '<a href="https://www.facebook.com/sharer/sharer.php?u='+link+'&t='+text+'" title="Share on Facebook" target="_blank"><img alt="Share on Facebook" src="social/facebook.png"></a>'+
						'<a href="https://twitter.com/intent/tweet?source='+link+'&text='+text+'%20'+link+'&via=shaan" target="_blank" title="Tweet"><img alt="Tweet" src="social/twitter.png"></a>'+
